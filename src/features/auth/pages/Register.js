...
const Register = () => {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.name === "email") setEmailAvailable(null);
  };
  ...
  }, 300); // shorter debounce for faster feedback
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        setError(
          serverMsg || "Registration failed. Please check your details."
        );
      }
    } finally {
      setLoading(false);
  ...
  return (
    <BackgroundFX>
      <Grid container sx={{ minHeight: "100dvh" }}>
        ...
        >
          <Box sx={{ maxWidth: "90%", width: "28rem" }}>
            <Typography
              variant="h3"
              sx={{
                fontWeight: 800,
            ...
            <Typography
              variant="h6"
              sx={{ opacity: 0.95, mb: 3, fontSize: "clamp(1rem,2vw,1.25rem)" }}
            >
              Create your account to save drafts, place orders, and track
              approvals across school years.
            </Typography>
            <Stack
              direction="row"
              spacing={1}
              ...
              >
                {["firstName", "lastName"].map((f) => (
                  <TextField
                    key={f}
                    required
                    label={f === "firstName" ? "First Name" : "Last Name"}
                    name={f}
                    variant="filled"
                    value={form[f]}
                ...
                {form.email && isValidEmail(form.email) && (
                  <Typography
                    ...
                    sx={{
                      gridColumn: "1 / -1",
                      color: emailAvailable === false ? "red" : "green",
                      mt: 0.5,
                    }}
                  >
                    {checkingEmail
